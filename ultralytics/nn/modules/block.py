...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           ...
           'BottleNeck', 'Blocks', "RetBlockC3", "Msfc", "SPDConv", "Soem", "Threedstack", "LFEBBase")
...
class LFEBBase(BasicBlock):
    def __init__(self, ch_in, ch_out, stride, shortcut, act='relu', variant='d'):
        super().__init__(ch_in, ch_out, stride, shortcut, act, variant)
        
        self.branch2b = LFEB(ch_out, ch_out)
...
class Threedstack(nn.Module):
    def __init__(self, inc, channel):
        super(Threedstack, self).__init__()
        if channel != inc[0]:
...
class soemchannel(nn.Module):
    def __init__(self, channel, b=1, gamma=2):
        super(soemchannel, self).__init__()
...
class soem_spatial(nn.Module):
    def __init__(self, channel, reduction=16):
        super(soem_spatial, self).__init__()
...
class Soem(nn.Module):
    ...
    def __init__(self, ch=256):
        super().__init__()
        self.channel_att = soemchannel(ch)
        self.local_att = soem_spatial(ch)
    def forward(self, x):
